...
auto test_cob_index_to_cobunit_info() -> void {
...
auto test_cobunit_info_to_cob_index() -> void {
...
auto test_track_index_map() -> void {
...
auto test_adjacent_connectors() -> void {
    auto cob = COB{0, 0};
